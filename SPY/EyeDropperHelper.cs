...
namespace MahApps.Metro.Controls
{
    internal static class EyeDropperHelper
    {
        ...
        public static Bitmap CaptureRegion(Int32Rect region)
        {
            //BitmapSource result;
            ...
            try
            {
                ...
                //result = System.Windows.Interop.Imaging.CreateBitmapSourceFromHBitmap(bitmap, IntPtr.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
            }
            finally
            {
        ...
        public static System.Windows.Media.Color GetPixelColor(Point point)
        {
            IntPtr hdc = GetDC(IntPtr.Zero);
            uint pixel = GetPixel(hdc, (int)Math.Round(point.X), (int)Math.Round(point.Y));
            ReleaseDC(IntPtr.Zero, hdc);
            System.Windows.Media.Color color = System.Windows.Media.Color.FromRgb((byte)(pixel & 0x000000FF),
